  ...
  switch (shu) {
    case 'shixiongbiji':
      return {
        id: 'shixiongbiji',
        name: '过去弟子的笔记',
        detail: `第一条，妖界每五十年入侵一次，门派会在此前十年广收门徒，以增强实力，抵御妖魔。

第二条，深厚的修为，配合上乘的仙术，再加锋利的兵器，可以战胜敌人。

第三条，蜀山弟子应当勤加修炼。

第四条，蜀山弟子通常修炼月余可成为入门弟子。

第五条，蜀对门派多有贡献，会被委以重任。

第六条，经常修习技艺，可能被收为入室弟子。

第七条，一贫长老和铸剑长老很少收入室弟子。
